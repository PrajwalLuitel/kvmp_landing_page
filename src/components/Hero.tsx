      ...
      <div className="container relative z-10 py-16 md:py-0">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            ...
            >
              Transforming <br />
              <span className="text-blue-200">Banking Technology</span>
              <br />
              For The Future
            </motion.h1>
            ...
            >
              Cutting-edge IT solutions & project management excellence for
            ...
            >
              <button
                ...
                className="p-4 bg-white text-blue-800 rounded-lg shadow-md transition-all duration-300 border border-white font-bold text-md"
              >
                Explore Solutions
              </button>
              <button
                onClick={() => scrollToSection("contact")}
                className="bg-transparent text-white font-medium p-4 rounded-lg border-2 border-white hover:bg-white hover:text-blue-700 transition-all duration-300 shadow-md hover:shadow-lg"
              >
                Contact Us
              </button>
            </motion.div>
              ...
              <div className="hero-circle">
                <div className="hero-inner-circle">
                  <Image
                    ...
                    width={180}
                    height={140}
                    className="logo-pulse bg-gray-100/10 rounded-full"
                  />
                </div>
              </div>
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden">
        ...
        >
          <path
            fill="#ffffff"
            fillOpacity="1"
            d="M0,160L48,170.7C96,181,192,203,288,197.3C384,192,480,160,576,154.7C672,149,768,171,864,197.3C960,224,1056,256,1152,261.3C1248,267,1344,245,1392,234.7L1440,224L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"
          ></path>
        </svg>
      </div>
    </section>
